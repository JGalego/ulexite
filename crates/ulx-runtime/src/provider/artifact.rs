...
//! system: image formats only (jpg/png/gif/webp), read directly off disk
//! at the HTTP-call boundary, with no new `Value` variant and no change to
//! the `Provider` trait's signature. PDF/video passthrough and a real
